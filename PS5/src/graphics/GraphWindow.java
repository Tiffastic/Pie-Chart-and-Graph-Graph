...
public class GraphWindow extends JFrame implements WindowListener
{
			...
			int operation, boolean usePieChart)
	{
		...
		setTitle("Thuy Nguyen's PS5 Display of Pie Chart and Bar Graph");
		setSize(400, 400);
		setVisible(true);
		...
		public void paintComponent(Graphics g)
		{
			try
			{
				...
				Grapher.drawGraph(g, column1, column2, categories, colors,
						operation, usePieChart, getWidth(), getHeight());
			}
			catch (RuntimeException e)
			{
				GraphWindow.this.processWindowEvent(new WindowEvent(
						GraphWindow.this, WindowEvent.WINDOW_CLOSING));
				throw e;
			}
		}
	}
